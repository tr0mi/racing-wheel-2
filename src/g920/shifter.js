    ...
    render() {
        ...
        return (
            <div style={{ position: 'relative' }}>
                ...
                <img id="shiftKnob" alt="" style={shifterStyle} src="/stream-racing-wheel/g920/shifter.png" />
            </div>
        )
    }
}
...
let onCustomProps = (key, value, store, ownProps) => {
    ...
    if (value.pressed) {
        switch (key) {
            //case 'buttons-' + ownProps.button1: gear = 7; gearButton = ownProps.button1; break;
            ...
            //case 'buttons-' + ownProps.gearButton1: gear = 7; gearButton = ownProps.gearButton1; break;
            case 'buttons-' + ownProps.reverse: gear = 0; gearButton = ownProps.reverse; document.getElementById("shiftKnob").style.width = "110px"; break;
            default: gear = -1; break;
        }
    }
    else if ('buttons-' + ownProps.gearButton === key) {
        gear = -1;
        document.getElementById("shiftKnob").style.width = "150px";
    }
    return {
        gear,
        gearButton
